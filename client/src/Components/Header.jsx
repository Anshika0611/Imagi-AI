...
const navigate = useNavigate()
  ...
  return (
    ...
    >
      ...
      <motion.p className='text-lg text-center max-w-xl mx-auto mt-5'
      initial={{opacity:0,y:20}}
      animate={{opacity:1,y:0}}
      ...
      className='flex flex-wrap justify-center  gap-3 mt-14 '>
        {Array(6).fill('').map((item,index)=>(
          ...
          className=' hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10'
      ...
      className='mt-2 text-neutral-700'>Generated images from Imagi-AI</motion.p>
    </motion.div>
  )
}
